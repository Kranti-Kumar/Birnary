  ...
  function F_Convert() {
    ...
    for (i = 0; i <= n; i++) {
      ...
      if (y == 1) {
        ...
        setnum("");
        settext("");
        alert("Number Ente#ADEFD1FF is not Binary");
        break;
      }
    }
    setnum(z);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.HeaderB}>
        <Text style={styles.Header}>Binary To Decimal </Text>
      </View>
      <View style={styles.reverse}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Decimal")}
        >
          <Text style={styles.convert}>Reverse</Text>
        </TouchableOpacity>
      </View>
      <Text style={styles.main}>Enter your Number (in Binary)</Text>
      ...
      <Text style={styles.main}> Number of Binary </Text>
      <Text style={styles.output}>{num}</Text>
